% output the net-prize of the identified subnetwork
...
fprintf(['FinalPrize(',num2str(multiple),')=',num2str(FinalPrize(Auto,multiple)),...
    ' Max Best=',num2str(max(FinalPrize(Auto,1:multiple))),'  TotalCost(',num2str(multiple),')=',...
    num2str(TotalCost(Auto,multiple)),' Min Best=',num2str(min(TotalCost(Auto,1:multiple))),'  Left Time=',num2str(lefttime),' hours.\n'])
%